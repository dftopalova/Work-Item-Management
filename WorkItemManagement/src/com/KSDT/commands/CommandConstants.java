...
//    TODO List all messages as constants
    ...
    public static final String WORK_ITEM_STATUS_SAME = "! Work item with ID %d has the same status.";
    ...
    public static final String STATUS_SUCCESSFULLY_CHANGED = "Status of work item with ID %d was changed from %s to %s.";
